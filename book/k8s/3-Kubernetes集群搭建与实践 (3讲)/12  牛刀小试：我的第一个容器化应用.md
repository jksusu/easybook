...
![img](https://static001.geekbang.org/resource/image/fa/f7/fa20fdb6a1f27bb3c8c024c4387488f7.jpg)
...
<audio title="12 | 牛刀小试：我的第一个容器化应用" src="https://res001.geekbang.org/media/audio/06/5a/068473ddafac8ef5798b843cddccf65a/ld/ld.m3u8"></audio>
...
那么，<font color=red>什么才是 Kubernetes 项目能“认识”的方式呢？</font>
...
<font color=red>接下来，如果我们要对这个 Nginx 服务进行升级，把它的镜像版本从 1.7.9 升级为 1.8，要怎么做呢？</font>
...
更重要的是，在部署到 Kubernetes 之后，接下来的所有操作，要么通过 kubectl 来执行，要么通过修改 YAML 文件来实现，就**尽量不要再碰 Docker 的命令行了。**
