...
![img](https://static001.geekbang.org/resource/image/12/70/12a18c84cab19f79f981c2bf918d0270.jpg)
...
<audio title="06 | 白话容器基础（二）：隔离与限制" src="https://res001.geekbang.org/media/audio/6e/67/6e9fa7ea0cb73d690a7c2fb70c026167/ld/ld.m3u8"></audio>
...
<font color="red">首先，既然容器只是运行在宿主机上的一种特殊的进程，那么多个容器之间使用的就还是同一个宿主机的操作系统内核。</font>
...
<font color=red>其次，在 Linux 内核中，有很多资源和对象是不能被 Namespace 化的，最典型的例子就是：时间。</font>
