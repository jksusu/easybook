...
![img](https://static001.geekbang.org/resource/image/ba/1a/babc20175eeaa8e9d33624fadabd011a.jpg)

![img](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADAAAAABCAYAAACYJC2PAAAAH0lEQVQImWN49+7dfxh49+4dHCOLUcLGZh65dmDTBwB5ubrfnypQGAAAAABJRU5ErkJggg==)![img](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABEAAAABCAYAAAA4u0VhAAAAFElEQVQImWN49+7dfxhAZ8MwIXkA6TJB8m/7SskAAAAASUVORK5CYII=)![img](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADAAAAABCAYAAACYJC2PAAAAH0lEQVQImWN49+7dfxh49+4dHCOLUcLGZh65dmDTBwB5ubrfnypQGAAAAABJRU5ErkJggg==)![img](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABEAAAABCAYAAAA4u0VhAAAAFElEQVQImWN49+7dfxhAZ8MwIXkA6TJB8m/7SskAAAAASUVORK5CYII=)

<audio title="09 | 从容器到容器云：谈谈Kubernetes的本质" src="https://res001.geekbang.org/media/audio/f3/10/f3aacd4be68691eb9b35a02d9adc3110/ld/ld.m3u8"></audio>
...
<font color=red>首先，Kubernetes 项目要解决的问题是什么？</font>
...
<font color=red>那么，Borg 对于 Kubernetes 项目的指导作用又体现在哪里呢？</font>
...
<font color=red>最后，我来回答一个更直接的问题：Kubernetes 项目如何启动一个容器化任务呢？</font>
...
这今天的分享中，我介绍了 Kubernetes 项目的架构。你是否了解了 Docker Swarm（SwarmKit 项目）和 Kubernetes 在架构上和使用方法上的异同呢？
