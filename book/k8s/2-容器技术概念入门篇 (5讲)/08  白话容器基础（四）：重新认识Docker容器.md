...
![img](https://static001.geekbang.org/resource/image/15/67/15019387582582520a24612fe7d5c767.jpg)
...
<audio title="08 | 白话容器基础（四）：重新认识Docker容器" src="https://res001.geekbang.org/media/audio/79/31/79e8421b8d2f88dc0b4733aa635def31/ld/ld.m3u8"></audio>
...
这里，我使用了 docker exec 命令进入到了容器当中。在了解了 Linux Namespace 的隔离机制后，你应该会很自然地想到一个问题：<font color=red>docker exec 是怎么做到进入容器里的呢？</font>
...
<font color=red>最后，我再来讲解一下 Docker 项目另一个重要的内容：Volume（数据卷）。</font>
